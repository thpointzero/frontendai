  ...
  render () {
    return (
      <Container>
        ...
        <p>Connect or create a wallet<br />
to earn amazing rewards!</p>
  
  <button className="btn btn-primary btn-block">Connect my wallet</button><br /><br /><br />
  <button className="btn btn-primary btn-block">Create a new wallet</button>
